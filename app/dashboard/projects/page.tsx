...
import { Plus, Search, FolderKanban, ExternalLink, Copy, Check, X } from 'lucide-react'
        ...
        {step === 'form' ? (
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <pre className="p-3 rounded-lg bg-[var(--surface-elevated)] border border-[var(--border)] text-sm font-mono overflow-x-auto whitespace-pre-wrap">
